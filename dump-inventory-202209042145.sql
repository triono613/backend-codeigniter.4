...
INSERT INTO `items` VALUES (1,'A1','TISSUE',200.00,'FOR TOILET'),(2,'A2','PAPER',500.00,'ATK');
...
INSERT INTO `migrations` VALUES (1,'2021-11-20-155858','Fluent\\Auth\\Database\\Migrations\\CreateAuthTables','default','App',1662266501,1),(2,'2022-09-04-044101','App\\Database\\Migrations\\Products','default','App',1662266501,1);
...
INSERT INTO `products` VALUES (1,'buku',50000),(2,'pulpen',15000);
...
CREATE TABLE `transaction_details` (
  ...
  KEY `item_id` (`item_id`),
  CONSTRAINT `transaction_details_ibfk_1` FOREIGN KEY (`trans_id`) REFERENCES `transactions` (`id`),
  CONSTRAINT `transaction_details_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-04 21:45:10
